...
import { Users, Phone, Mail, ShieldCheck, Award, Sparkles } from 'lucide-react';
            ...
            <div className="space-y-1.5 text-center sm:text-left flex-1">
              ...
              <div className="pt-2 flex items-center justify-center sm:justify-start gap-3">
                <a
                  ...
                  className="px-3 py-1.5 rounded-xl btn-primary text-xs font-bold transition-all flex items-center gap-1.5"
                >
