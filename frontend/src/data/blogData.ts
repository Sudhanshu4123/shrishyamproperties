...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    metaDescription: 'Top sectors to buy builder floors, DDA flats and society apartments in Dwarka, New Delhi. Sector connectivity, price trends & amenities guide.',
  ...
  },
  {
    ...
    metaDescription: 'Legal checklist of essential documents for buying a flat or builder floor in Delhi: Title deed, mutation, RERA, encumbrance certificate & NOCs.',
  ...
  },
  {
    ...
    metaDescription: 'Builder Floors vs DDA Flats in Dwarka: Compare living space, privacy, parking, construction quality, maintenance costs, and long-term resale returns.',
  ...
  },
  {
    ...
    metaDescription: '10-point inspection checklist before buying property in Dwarka, Delhi: Water supply, parking, lift, build quality, registry & title verification.',
