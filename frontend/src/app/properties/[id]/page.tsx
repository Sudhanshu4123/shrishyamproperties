...
import { 
  ...
  CheckCircle, Box, Phone, MessageCircle, ArrowLeft, ShieldCheck, Share2 
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#f0f4f8] text-slate-800 flex flex-col font-sans">
      ...
      <main className="pt-24 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full flex-1">
        ...
        <button
          onClick={() => router.back()}
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white text-slate-700 hover:text-teal-600 hover:border-teal-500 text-xs font-bold mb-6 border border-slate-200 shadow-sm transition-all"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm">
              <h3 className="text-base font-bold text-slate-800 mb-4 border-l-4 border-teal-500 pl-3">
            ...
            <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm space-y-4">
              <h3 className="text-base font-bold text-slate-800 border-l-4 border-teal-500 pl-3">
